    ...
    tabsetPanel(id = ns("visual_tab"),
                ...
                tabPanel("MFA: Individuals",
                         fluidRow(
                           ...
                           column(3,
                                  br(),
                                  numericInput(ns("mfa_individuals_plot_height"), "Plot Height (px)", value = 600, min = 300, step = 50, width = '150px'), 
                                  numericInput(ns("mfa_individuals_plot_width"), "Plot Width (px)", value = 700, min = 200, step = 50, width = '150px'), 
                                  hr(),
