mod_allometry_ui_combined <- function(id) {
  ...
  tagList(
    ...
    p(strong("Note: Allometric correction should only be performed on morphometric data and not on meristic, categorical, or other non-morphometric data."), style = "color: red;"),
