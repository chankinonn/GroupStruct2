...
mod_data_server_morphometric <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    # -------------------------------------------------------------------------
    parse_morphometric_df <- function(df, group_col, id_col = NULL) {
    ...
    observeEvent(input$apply_cols, {
      ...
      apply_result(parse_morphometric_df(df, group_col = input$col_otu, id_col = id_col),
    ...
    observeEvent(input$load_example, {
      ...
      apply_result(parse_morphometric_df(df, group_col = otu_col),
