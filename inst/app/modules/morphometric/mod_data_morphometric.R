...
mod_data_ui_morphometric <- function(id) {
  ...
  tagList(
    ...
    p("Note on the example dataset: This example dataset contains 15 morphometric traits from four species of lizards. The second column (SVL) represents body size. Select this when performing allometric correction"),
