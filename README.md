...
# The mclust package needs to be at least version 6. 
# If you are using R 4.3 or higher, you will need a GNU Fortran 12.2 compiler. 
# Please see <https://cran.r-project.org/bin/macosx/tools/> for more details.
